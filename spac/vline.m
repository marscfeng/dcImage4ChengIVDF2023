function hhh=vline(x, in1, in2, linewidth, linecolor)
% function h=vline(x, linetype, label, linewidth, linecolor)
%
...
%
% Modification
%     v.1 add linewidth/linecolor, F. Cheng, Nov-30-2021
%
...
if length(x)>1  % vector input
    ...
    y=get(gca,'ylim');
    h=plot([x x],y,linetype,'LineWidth',linewidth);
    %
